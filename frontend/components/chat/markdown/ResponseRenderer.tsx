...
const markdownComponents: Components = {
  ...
  code({ children, ...props }) {
    ...
    const combinedClassName = ["bg-white/10 px-1.5 py-0.5 rounded text-[0.85em] font-mono text-primary-light whitespace-pre-wrap break-words", className].filter(Boolean).join(" ");
    return (
